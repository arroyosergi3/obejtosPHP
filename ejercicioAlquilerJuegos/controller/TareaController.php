...
class TareaController{
    ...
    public static function update($p) {
        try {
            $conex = new Conexion();
            $conex->query("UPDATE tareas set  nombre = '$p->nombre', fechaInicio = '$p->fechaInicio', fechaFin = '$p->fechaFin' where id = $p->id");
     ...
     public static function buscarPorNOmbre($em) {
        try {
            ...
            if ($result->num_rows) {
                ...
                $p = new Tarea($fila->nombre, $fila->fechaInicio, $fila->fechaFin);
                $p->nuevaTarea($fila-> id ,$fila->nombre, $fila->fechaInicio, $fila->fechaFin);
